                        ...
                        <Navbar.Collapse id="responsive-navbar-nav">
                            <Nav className="me-auto">
                                <Navbar.Brand href="/" className="d-flex justify-content-center align-items-center gap-2">
                                    ...
                                    <span>
                                      <span style={{color: 'orange', fontStyle: 'italic', fontSize: '25px', fontWeight: 'bold'}}>Fontana Car Rental</span>&nbsp;&nbsp;<span style={{fontSize: '18px', color: 'white', fontWeight: 'bold'}}></span>
                                    </span>
                                    {/*</Link>*/}
                                </Navbar.Brand>
                            </Nav>
